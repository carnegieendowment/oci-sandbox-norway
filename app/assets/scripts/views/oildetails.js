...
var OilDetails = BaseView.extend({
  ...
  createChartData: function () {
    ...
    var defaultModelData = {
      info: Oci.data.info,
      opgee: Oci.Collections.opgee.get(utils.getOPGEEModel('0', '0', '0', '2014')).toJSON(),
      prelim: Oci.Collections.prelim.get(utils.getPRELIMModel('0', '0 = Default', 1, '2014')).toJSON()
    };
    ...
    var prelimRun = utils.getPRELIMModel(params.gwp, params.refinery, params.lpg, params.year);
